...
export default function BrandStorySection() {
  return (
    <section className="relative py-8 sm:py-10 bg-[var(--bg-primary)] text-[var(--text-primary)] border-t border-b border-[var(--border-subtle)] overflow-hidden select-none transition-colors">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center opacity-[0.02] dark:opacity-[0.04] overflow-hidden">
        <span className="font-black text-[18vw] tracking-tighter uppercase select-none leading-none">
          DEPLOY
        </span>
      </div>

      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[220px] bg-[var(--accent-primary)]/10 blur-[100px] rounded-full" />

      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-7 z-10">
        ...
        <div className="text-center space-y-2.5 sm:space-y-3">
          ...
          <div className="space-y-1.5 max-w-3xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tight leading-[1.08] text-[var(--text-primary)]">
        ...
        {/* Minimalist Industrial Spec Strip (Clean & Compact) */}
        ...
        <div className="space-y-3 pt-1">
          <div className="text-center sm:text-left">
            <h3 className="text-base sm:text-lg font-black uppercase tracking-tight text-[var(--text-primary)]">
              Why Choose Us
            </h3>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
            ...
            <div className="p-3 sm:p-3.5 rounded-xl bg-[var(--bg-surface)] dark:bg-[#111116] border border-[var(--border-subtle)] dark:border-white/10 flex flex-col items-start gap-2 shadow-xs hover:border-[var(--accent-primary)]/50 transition-colors">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-[var(--text-primary)] dark:text-white">
                  Premium Fabric
                </h4>
